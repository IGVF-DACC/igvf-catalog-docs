...
## Overview
The IGVF Catalog contains genomic elements, which are potential functional regions for regulating gene expression. These elements are identified/tested by functional assays (e.g., MPRA), association studies (e.g., caQTLs), and computational predictions (e.g., the [ENCODE-rE2G model](https://doi.org/10.1038/s41586-026-10781-4)).
...
Currently, this table includes predictions from the ENCODE-rE2G model (see [Gschwind et al. Nature 2026](https://doi.org/10.1038/s41586-026-10781-4)) across 1,458 ENCODE DNase-seq experiments, spanning 369 distinct biosample terms
