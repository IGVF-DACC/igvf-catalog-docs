...
The  official gene sets of the IGVF Catalog are from the following GENCODE releases:
...
Score ranges from 0 (no prediction) to 1 (confident prediction). Currently, this table includes predictions from the ENCODE-rE2G model (see [Gschwind et al. Nature 2026](https://doi.org/10.1038/s41586-026-10781-4)) across 1,458 ENCODE DNase-seq experiments, spanning 369 distinct biosample terms
...
| Column | Description |
|--------|-------------|
| Disease | Name of the disease (click for details) |
| Ontology term ID | Unique identifier for the disease ontology term |
| Gene name | Name of the associated gene (click for gene details) |
| PMIDs | PubMed IDs supporting the association |
| Association type | Type of gene-disease association |
| Association status | Status of the gene-disease association |
| Source | Source of the disease association (ClinGen, Orphanet) |
